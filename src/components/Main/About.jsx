        ...
        <div className="row container">
            <div className="columns" data-aos="fade-right" data-aos-delay="300">
                ...
                <h4>
                    <FormattedMessage
                        id='description'
                        defaultMessage='My name is Oswaldo Yesith Monsalvo and I am a full stack developer.'
                    />
                </h4>
                <p>
                    <FormattedMessage
                    ...
                    <li>
                        <p>
                            <span>
                                ...
                                Aprender, jugar y divertirme
                        </p>
                    </li>
                    <li>
                        <p><span>Email:</span> monsalvoosvaldo18@gmail.com</p>
                    </li>
                    <li>
                        <p>
                            <span>
                ...
                <div className="mas-info">
                    <a href={cv} target="_blank" rel="noopener noreferrer" download="CV.OSWALDO.pdf" className="btn-codigo buttonDownload">
                        <FormattedMessage
                            id='btn-cv'
            ...
            <div className="columns col-skill" data-aos="fade-left" data-aos-delay="650">
                ...
                <div className="skill">
                    ...
                    <div>
                        <img alt="sql" className="icons-skils" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/mysql/mysql-original.svg" />
                        <h5>SQL</h5>
                    </div>
                    <div>
                    ...
                    <div>
                        <img alt="Laravel" className="icons-skils" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/laravel/laravel-plain.svg" />
                        <h5>Laravel</h5>
                    </div>
                </div>
                <h4>
                ...
                <div className="skill">
                    <div>
                        <img alt="Linux" className="icons-skils" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/linux/linux-original.svg" title="figma" />
                        <h5>Linux</h5>
                    </div>
                    <div>
                        <img alt="Bitbucket" className="icons-skils" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/bitbucket/bitbucket-original.svg" title="Photoshop" />
                        <h5>Bitbucket</h5>
                    </div>
                    <div>
